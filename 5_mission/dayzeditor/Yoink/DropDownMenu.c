class VPPDropDownMenu extends ScriptedWidgetEventHandler
{
	...
	{
		m_Root = GetGame().GetWorkspace().CreateWidgets("P:\DayZ_Server\dev\DayZEditor\5_mission\dayzeditor\Yoink/VPPDropdown/dropdown_prefab.layout", root);
	...
	{
		ButtonWidget element = ButtonWidget.Cast(GetGame().GetWorkspace().CreateWidgets("P:\DayZ_Server\dev\DayZEditor\5_mission\dayzeditor\Yoink/VPPDropdown/dropdown_element.layout", m_ContentContainer));
