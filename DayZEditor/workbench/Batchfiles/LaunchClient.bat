...
start %clientEXE% %clientLaunchParams% "-mod=P:/Mods/@Community-Framework;P:/Mods/@BuilderItems;%modList%;P:/Mods/@oof" "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true" "-mission=P:\profiles\Client\Users\Tyler\DayZEditor.ChernarusPlus"
