...
start %clientEXE% %clientLaunchParams% "-mod=P:/Mods/@Community-Framework;P:/Mods/@BuilderItems;P:/Mods/@Community-Online-Tools;P:/Mods/@DayZ-Expansion;P:/Mods/@DayZ-Expansion-Licensed;" "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true" "-mission=P:\profiles\Client\Users\Tyler\Expansion.ChernarusPlusGloom"
