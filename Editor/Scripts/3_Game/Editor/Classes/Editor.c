...
class Editor: TreeNode
{
	...
	void Editor(string uuid, string display_name, Symbols icon, PlayerIdentity identity, DayZPlayer player) 
	{
		...
		commands.Add(new CommandNode("Afterlife", "View Hidden", Symbols.GHOST));
		commands.Add(new CommandNode("Bolt", "Lightning Bolt", Symbols.BOLT));
		commands.Add(new CommandNode("BoxSelect", "Box Selection", Symbols.SQUARE_DASHED));
		commands.Add(new CommandNode("Camera", "Camera", Symbols.CAMERA));
		commands.Add(new CommandNode("CircleSelect", "Circle Selection", Symbols.CIRCLE_DASHED));
		...
		commands.Add(new CommandNode("LassoSelect", "Lasso Select", Symbols.LASSO));
		commands.Add(new CommandNode("Lock", "Lock", Symbols.LOCK));
		commands.Add(new CommandNode("Magnet", "Magnet", Symbols.MAGNET));
		commands.Add(new CommandNode("New", "New File", Symbols.FILE));
		commands.Add(new CommandNode("Open", "Open File", Symbols.FOLDER_OPEN));
		...
		commands.Add(new CommandNode("Weather", "Weather", Symbols.CLOUD_SUN));
		commands.Add(new CommandNode("CursorToggle", "Toggle Cursor", Symbols.ARROW_POINTER));
		Add(commands);
