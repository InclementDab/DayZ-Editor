...
class CfgSoundShaders
{
	...
	{
		samples[] = {{"Editor\sounds\notification", 1}};
	};
	class THX_Soundshader: Editor_Soundshader
	{
		samples[] = {{"Editor\sounds\thx", 1}};
	};
	...
	{
		samples[] = {{"Editor\Sounds\Environment\WindForestLight_-9db",1}};
	...
	{
		samples[] = {{"Editor\Sounds\Environment\WindHousesHeavy_-9db",1}};
