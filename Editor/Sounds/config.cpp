...
class CfgSoundShaders
{
    class ForestDay_SoundShader
    {
        ...
        volume="( (( 1.6 * trees ) / ( trees + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (((1 - (rain factor [0.25, 1]))) max (0.8))";
    };
    class ForestNight_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\ForestNight_-30db", 1}};
        volume="( (( 1.6 * trees ) / ( trees + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (( 1.6 * night ) / ( night + 0.6 )) * (rain factor[0.3,0.1]) * (windy factor[0.5,0.2])";
    };
    class ForestDayBirds_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\ForestDayBirds", 1}};
        volume="0.25 * (( 1.6 * forest ) / ( forest + 0.6 )) * ( 1 - (( 1.6 * night ) / ( night + 0.6 ))) * (rain factor[0.3,0.1]) *  (windy factor[0.7,0.2]) * ((overcast factor[0.8,0.6]) min (fog factor[0.9,0.4])) * (0.25 + 0.75*(shooting factor [0.6,1])) * (altitudeGround factor[15,10])";
    };
    class HousesDay_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\HousesDay_-30db", 1}};
        volume="( (( 1.6 * houses ) / ( houses + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (((1 - (rain factor [0.25, 1]))) max (0.5))";
    };
    class HousesNight_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\HousesNight_-30db", 1}};
        volume="( (( 1.6 * houses ) / ( houses + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (( 1.6 * night ) / ( night + 0.6 )) * (rain factor[0.3,0.1]) * (windy factor[0.4,0.1])";
    };
    class MeadowDay_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\ForestDay_-30db", 1}};
        volume="( (( 1.6 * meadow ) / ( meadow + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (((1 - (rain factor [0.25, 1]))) max (0.5))";
    };
    class MeadowDayCrickets_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\MeadowDayCrickets", 1}};
        volume="(( 1.6 * meadow ) / ( meadow + 0.6 )) * ( 1 - (( 1.6 * night ) / ( night + 0.6 ))) * (rain factor[0.3,0.1]) * (windy factor[0.7,0.2]) * ((overcast factor[0.8,0.6]) min (fog factor[0.9,0.4])) * (daytime factor[0.6,0.58]) * (0.25 + 0.75*(shooting factor [0.6,1]))";
    };
    class MeadowEveningCrickets_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\MeadowEveningCrickets", 1}};
        volume="(( 1.6 * meadow ) / ( meadow + 0.6 )) * ( 1 - (( 1.6 * night ) / ( night + 0.6 ))) * (rain factor[0.3,0.1]) * (windy factor[0.7,0.2]) * ((overcast factor[0.8,0.6]) min (fog factor[0.9,0.4])) * (daytime factor[0.58,0.6]) * 0.7 * (0.25 + 0.75*(shooting factor [0.6,1]))";
    };
    class MeadowNight_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\MeadowNight_-30db", 1}};
        volume="( (( 1.6 * meadow ) / ( meadow + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (( 1.6 * night ) / ( night + 0.6 )) * (rain factor[0.3,0.1]) * (windy factor[0.5,0.2]) * ((daytime factor[0.5,0.6]) + (daytime factor[0.1,0]))";
    };
    class MeadowNight2_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\MeadowNight2_-30db", 1}};
        volume="( (( 1.6 * meadow ) / ( meadow + 0.6 )) / ((( 1.6 * trees ) / ( trees + 0.6 )) + (( 1.6 * houses ) / ( houses + 0.6 )) + (( 1.6 * meadow ) / ( meadow + 0.6 )) + (( 1.6 * sea ) / ( sea + 0.6 )))) * (( 1.6 * night ) / ( night + 0.6 )) * (rain factor[0.3,0.1]) * (windy factor[0.5,0.2]) * ((daytime factor[0,0.1]) - (daytime factor[0.5,0.6]))";
    };
    class Coast_SoundShader
    {
        samples[]={{"DZ\sounds\environment\ambients\Coast", 1}};
        volume="(((altitudeSea - altitudeGround) factor[4.5,1]) max ((coast factor [0.955,1]) / 1.5)) * (sea factor[0.1,0.2]) * (altitudeSea factor[15,10]) * (houses factor[1,0.9]) * (waterDepth factor[15,10])";
    };
    ...
    class FlyAmbience_SoundShader
    {
        ...
        volume="(windy factor[0.4,0]) * meadow * (1 - night) * (0.25 + 0.75*(shooting factor [0.6,1])) * (1 - (fog factor[0.1,0.4])) * (1 - (rain factor[0.15,0.2]))";
    };
