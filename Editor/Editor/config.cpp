...
class CfgVehicles
{
	...
	{
		scope = 1;
		model = "\Editor\Editor\CameraNormal.p3d";
	};

	class StaticCameraChristmas: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\Camera_xmas_Normal.p3d";
	};

	class StaticCameraAnniversary: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\Camera.p3d";
	};

	class XmasGiftRed1: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_red1.p3d";
	};
	class XmasGiftRed2: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_red2.p3d";
	};
	class XmasGiftGreen1: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_green1.p3d";
	};
	class XmasGiftGreen2: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_green2.p3d";
	};
	class XmasGiftBlue1: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_blue1.p3d";
	};
	class XmasGiftBlue2: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\xmas_gift_blue2.p3d";
	};

	class BrushBase: HouseNoDestruct
	{
		scope = 1;
		model = "\Editor\Editor\BrushBase.p3d";
		hiddenSelections[] = {"BrushBase"};
		hiddenSelectionTextures[] = { "Editor\\Editor\\data\\BrushDelete.paa" };
		shadow = 0;
	};
	...
	{
		scope = 1;
		model = "\Editor\Editor\BoundingBoxBase.p3d";
	...
	{
		scope=2;
		model="Editor\editor\DebugCylinder.p3d";
	};
	...
	class DZE_Logo_Graffiti: HouseNoDestruct
	{
		...
		model="\Editor\Editor\Logo_Graffiti.p3d";
		shadow = 0;
	};
/*
	...
	{
		scope = 1;
		model = "\Editor\Editor\CinematicCamera.p3d";
	...
	{
		scope=2;
		model="Editor\editor\Gizmo.p3d";
	};
	class jdTestBox1: HouseNoDestruct
	{
		scope=2;
		model="Editor\editor\TestBox1.p3d";
	};
};